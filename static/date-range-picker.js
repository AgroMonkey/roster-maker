        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            ...
            '<div class="daterangepicker">' +
                ...
                '<div class="drp-calendar right">' +
                    ...
                    '<div class="calendar-time"></div>' +
                '</div>' +
                '<div class="drp-buttons text-center">' +
                    '<span class="drp-selected px-0"></span>' +
                    '<div class="row mt-2">' +
                        '<button class="cancelBtn ml-auto" type="button"></button>' +
                        '<button class="applyBtn mr-auto" disabled="disabled" type="button"></button> ' +
                    '</div>' +
                '</div>' +
            '</div>';
